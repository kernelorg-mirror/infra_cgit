...
--
-- ezgb.lua is not part of cgit. It lives under lua/ in
-- https://git.kernel.org/pub/scm/utils/ezgb/ezgb.git, which also carries a
-- rockspec: "luarocks make lua-ezgb-scm-1.rockspec" from that checkout
-- installs it.
--
-- cgitrc configuration:
--   enable-bugs=1
--   bugs-filter=lua:/path/to/filters/bugs-git-bug.lua
--
